...
$config = array(
        ...
        "title" => "Axe Faucet", // page title, may be used by the template too
        "sitename" => "Axe Faucet", // page title, may be used by the template too
        "sitedesc" => "Axe", // page title, may be used by the template too
        "coin_code" => "AXE",
